...
/**
 * 此类是为了对token进一步操作,对org.springframework.security.oauth2.provider.token.DefaultTokenServices的复制和扩展.
 * 在AuthorizationServerConfiguration中设置
 * <pre>
...
public class CustomDefaultTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
    ...
    public OAuth2AccessToken refreshAccessToken(String refreshTokenValue, TokenRequest tokenRequest)
        ...
        if (isExpired(refreshToken)) {
            //删除RefreshToken的操作在CustomOAuth2AuthenticationEntryPoint.commence()中进行
            //tokenStore.removeRefreshToken(refreshToken);
    ...
    public OAuth2Authentication loadAuthentication(String accessTokenValue) throws AuthenticationException,
        ...
        if (accessToken == null) {
            ...
            long remaining = accessToken.getExpiration().getTime() - System.currentTimeMillis();
            if (remaining < 5000) { //refresh_token过期时间小于5秒时强势过期,以便刷新操作.
                //删除AccessToken的操作在CustomOAuth2AuthenticationEntryPoint.commence()中进行
